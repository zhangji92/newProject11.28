...
public class PullToRefreshWebView extends PullToRefreshBase<WebView> {
	...
	protected boolean isReadyForPullEnd() {
		...
		return true;
				//mRefreshableView.getScrollY() >= (exactContentHeight - mRefreshableView.getHeight());
	}
	...
	final class InternalWebViewSDK9 extends WebView {
		...
		private int getScrollRange() {
			return 0;
//					(int) Math.max(0, FloatMath.floor(mRefreshableView.getContentHeight() * mRefreshableView.getScale())
