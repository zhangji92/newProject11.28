...
public class LoanScrollWarpLayout extends LinearLayout {
    ...
    public LoanScrollWarpLayout(Context context, AttributeSet attr) {
        super(context, attr);
    ...
    public LoanScrollWarpLayout(Context context) {
        super(context);
        this.setOrientation(LinearLayout.VERTICAL);
        // 初始化平滑滚动器
        mScroller = new Scroller(getContext(), new OvershootInterpolator(OVERSHOOT_TENSION));
