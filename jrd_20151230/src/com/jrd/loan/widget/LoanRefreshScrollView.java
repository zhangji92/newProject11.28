 ...
 * <br>
 * <strong>策略:</strong> 获取ScrollView的子视图并添加到自定义的{@link LoanScrollWarpLayout}
 * 滚动视图中 将滚动视图添加到ScrollView作为子视图,所有的弹性滚动都由{@link LoanScrollWarpLayout}来完成
 *
 * @author King
 */
public class LoanRefreshScrollView extends ScrollView {
     ...
     * 自定义的弹性滚动视图
     */
    private LoanScrollWarpLayout mContentLayout;
    ...
    public LoanRefreshScrollView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initScrollView();
    }

    public LoanRefreshScrollView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LoanRefreshScrollView(Context context) {
        this(context, null);
    }
    ...
    private void initOverScrollLayout() {
        ...
        if (mContentLayout == null) {
            ...
            // 初始化弹性滚动视图
            mContentLayout = new LoanScrollWarpLayout(getContext());
            // 移除ScrollView所有视图
            this.removeAllViews();
