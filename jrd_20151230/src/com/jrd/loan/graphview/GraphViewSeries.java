...
public class GraphViewSeries {
     ...
     *
     * @param values the values must be in the correct order! x-value has to be ASC. First the lowest
    ...
    /**
     * add one data to current data the values must be in the correct order! x-value has to be ASC.
     * First the lowest x value and at least the highest x value.
     *
     * @param value the new data to append. Important: the new value must be higher then the last
     *        value (x).
