...
package com.jrd.loan.wheel.widget;
...
import com.jrd.loan.wheel.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.loan_divider_line_color));
        // 设置线宽
