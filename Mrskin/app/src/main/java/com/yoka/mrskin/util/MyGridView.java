...
{  
    ...
    private void init(Context context) { 
        ...
        // 下拉箭头
        arrowImageView = (ImageView) headView.findViewById(R.id.xlistview_header_arrow);
        arrowImageView.setMinimumWidth(70);
        arrowImageView.setMinimumHeight(50);
        // 进度条
        progressBar = (ProgressBar) headView.findViewById(R.id.xlistview_header_progressbar);
        // 下拉提示 刷新
