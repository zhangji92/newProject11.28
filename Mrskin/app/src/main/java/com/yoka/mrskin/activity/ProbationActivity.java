 ...
 * 
 */
public class ProbationActivity extends BaseActivity implements OnClickListener,
IXListViewListener
{
    ...
    private static final int REQUSET_CODE = 13;
...
//                TrackUrl.PAGE_CLOSE + "ProbationActivity");
    ...
    private void initView() {
        ...
        mHeaderView = LayoutInflater.from(ProbationActivity.this).inflate(
                R.layout.no_net_header_view, null);
        mListView = (XListView) findViewById(R.id.probation_xlistview);
        mListView.setPullRefreshEnable(true);
        mListView.setPullLoadEnable(true);
        mListView.setXListViewListener(this);
        mListViewFooter = new XListViewFooter(ProbationActivity.this);
...
//                        + "&type=trial");
    ...
    private void getData(final boolean isRefresh, int type, boolean isAnim) {
        ...
        mTempType = type;
        System.out.println("ProbationActivity type = " + type);
            ...
            public void callback(YKResult result,
                ...
                if (result.isSucceeded()) {
                    ...
                    if (products.size() > 0) {
                        ...
                        Toast.makeText(ProbationActivity.this,
    ...
    public void onClick(View v) {
        ...
        case R.id.probation_no_product_go_layout:
            ProbationActivity.this.setResult(RESULT_OK);
            this.finish();
            break;
        }
    }
    ...
    private class MyAdapter extends BaseAdapter
    {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(ProbationActivity.this)
         ...
         //   Glide.with(ProbationActivity.this).load(product.getCover().getmURL()).into( viewHolder.mImage).onLoadStarted(getResources().getDrawable(R.drawable.list_default_bg));
    ...
    private void confirmProduct(String productId) {
        YKConfirmProductManager.getInstnace().requestConfirmProduct(productId,
            ...
            public void callback(YKResult result) {
                if (result.isSucceeded()) {
                    getData(true, ALL, true);
                    Toast.makeText(ProbationActivity.this, "确认收货成功",
                            Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(ProbationActivity.this, "请求失败",
                            Toast.LENGTH_SHORT).show();
                }
            }
        });
